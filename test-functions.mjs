...
console.log('\n[10] /article 预渲染（Bing 指引 §8/§9/§13/§21 索引增强）');
{
  ...
  check('目录预渲染：TOC 卡片写入页面源码（含评论/首页按钮）', p.status === 200 && p.text.includes('toc-card') && p.text.includes('toc-list') && p.text.includes('class="toc-btn toc-comment" href="#commentWrap"') && p.text.includes('class="toc-btn toc-home" href="index.html"'), p.text.slice(0, 300));
